...
Lynott et al. (2014), replicating Williams & Bargh (2008) conducted a study to investigate the effect of being exposed to physical warmth on interpersonal warmth and prosocial behavior. They observed  that 51.2% of participants who received a cold pack (n = 427) opted to receive a reward for themselves, while 57.9% (n = 434) of participants who received a warm pack did the same. Calculating a z-test for the difference between the proportions, this effect is statistically significant (Diff = -0.067, z = -1.98, p = 0.024). Having obtained a significant result, we are left with two alternatives:

1. The difference is small enough that even though it is *statisitcally* significant, we can consider it *practically* equivalent to zero.
