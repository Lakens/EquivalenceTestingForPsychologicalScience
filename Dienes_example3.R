...
power <- pwr.t.test(n = orig.N, d = NULL, sig.level = 0.05, power = 0.33, type = "two.sample", alternative = "two.sided")
d.33 <- power$d
...
##Brandt.1.1.1## TOST: small telescopes; BF: halfnormal
# Dienes: BF = 0.97 --> successfully replicated
Brandt.1.1.1 <- TOSTtwo.raw.nm(m1=rep.m1, 
                               m2=rep.m2, 
                               sd1=rep.sd1, 
                               sd2 = rep.sd2, 
                               n1 = rep.n1, 
...
##Brandt.1.2.1## TOST: critical effect; BF: halfnormal
# Dienes: BF = 0.97 --> successfully replicated
...
##Brandt.2.1## TOST: small telescopes; BF: halfnormal
# Dienes: BF = 0.97 --> successfully replicated
Brandt.2.1 <- TOSTtwo(m1=rep.m1, 
                      m2=rep.m2, 
                      sd1=rep.sd1, 
                      sd2 = rep.sd2, 
                      n1 = rep.n1, 
...
##Brandt.2.2## TOST: critical effect; BF: halfnormal
# Dienes: BF = 0.97 --> successfully replicated
Brandt.2.2 <- TOSTtwo(m1=rep.m1, 
                      m2=rep.m2, 
                      sd1=rep.sd1, 
                      sd2 = rep.sd2, 
                      n1 = rep.n1, 
