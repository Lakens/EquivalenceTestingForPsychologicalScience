...
TOSTER::TOSTtwo(m1  = 4.785714,   # Mean of group 1
                ...
                low_eqbound  = -0.4929019,  # Value for the lower equivalence bound
                high_eqbound =  0.4929019,  # Value for the higher equivalence bound
